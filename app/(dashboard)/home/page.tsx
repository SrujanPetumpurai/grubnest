    ...
    return(
        <div className=''>
            ...
            <div className='flex flex-col md:flex-row mx-auto items-center w-[1200px] max-w-[95vw] justify-between gap-6'>
                ...
                <img className='hidden md:inline-block w-[40%] sm:w-[25%] md:w-[16%] rounded-full transition-all delay-700 duration-1000 ease-in-out hover:-translate-y-200 h-auto mx-auto my-2' src="/logo_better.png" alt="" />
